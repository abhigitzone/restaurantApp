...
public class MexicanAdapter extends RecyclerView.Adapter<MexicanAdapter.MyViewHolder> {
    public Context mContext;
    List<NorthData> northData;

    public MexicanAdapter(Context mContext, List<NorthData> northData) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            switch (id) {
                case 0: {
                    //Base price of food is set to $22..
                    int basePrice = 22;
        ...
        //Call this function every time when order button is clicked..
