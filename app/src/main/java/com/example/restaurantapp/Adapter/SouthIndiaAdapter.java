...
public class SouthIndiaAdapter extends RecyclerView.Adapter<SouthIndiaAdapter.MyViewHolder> {
    public Context mContext;
    List<NorthData> northData;

    public SouthIndiaAdapter(Context mContext, List<NorthData> northData) {
